...
var Codesign = function(){
	...
	var handleSupport = function(){
		var support = '<script id="DZScript" src="">';
...
// JavaScript script to set 'active' class based on current URL
document.addEventListener("DOMContentLoaded", function() {
    // Get all the <a> tags within the navbar
    ...
    navLinks.forEach(function(link) {
        // Check if the href of the nav item matches the current URL
