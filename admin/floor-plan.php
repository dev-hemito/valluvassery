            ...
            <section>
                <div class="container">
                    <div class="col-lg-8 mx-auto login-form bg-light p-3 m-3 mt-5 rounded">
                        ...
                        <form method="POST" enctype="multipart/form-data" action="plan/add.php">
                            ...
                            <div class="img-upload position-relative">
                                ...
                                <input type="file" name="image[]" multiple accept="image/png, image/gif, image/jpeg" id="imageFile" required placeholder="choose image">
                            </div>
                            <br>
