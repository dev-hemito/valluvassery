...
<body>
    ...
    <div class="container">
        <div class="col-lg-8 mx-auto login-form bg-light p-3 m-3 mt-5 rounded">
            ...
            <div class="row">
                <?php
                $query = "SELECT g.id, g.img, g.project, p.name AS project_name FROM plan g INNER JOIN project p ON g.project = p.id";
                        ...
                        <div class="col-md-6">
                            <div class="project bg-white mb-4 p-2">
                                ...
                                <div class="content">
                                    ...
                                    <a href="plan/delete.php?id=<?php echo $id; ?>&img=<?php echo $imgName; ?>"  onclick="return confirmDelete();" class="bg-danger text-white p-1">Delete</a>
                                </div>
                            </div>
                        </div>
                <?php
